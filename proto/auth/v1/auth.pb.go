...
func (x *AuthResponse) GetAccessTokenExpiresAt() int64 {
	if x != nil {
...
func (x *AuthResponse) GetRefreshTokenExpiresAt() int64 {
	if x != nil {
...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x1b\n" +
	"\tdevice_id\x18\x03 \x01(\tR\bdeviceId\"\xc6\x01\n" +
	"\fAuthResponse\x12!\n" +
	...
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x15.auth.v1.AuthResponseB\x16Z\x14proto/auth/v1;authv1b\x06proto3"
...
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	...
	3, // 2: auth.v1.AuthService.ValidateToken:input_type -> auth.v1.ValidateTokenRequest
	...
	2, // 7: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.AuthResponse
